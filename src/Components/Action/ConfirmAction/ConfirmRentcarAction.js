...
export const ConfirmRentcarAction = ({id}) => {
  ...
  return (
    <td id='Button'>
        <a href={'rentcar/info-1/' + id.original._id} id='Info'><AiFillInfoCircle size={40} />&nbsp; <div>ดูข้อมูล</div></a>
        <>
            ...
            <Modal show={show} onHide={handleClose} backdrop="static" keyboard={false} className="modal" >
                ...
                <Modal.Footer className="modalFooter">
                    ...
                    <Button variant="primary" className="modalButtonPrimary" onClick={() => {rejectRentcarPartner(id.original._id)}}>ยืนยัน</Button>
                </Modal.Footer>
            </Modal>
        </>
        <>
            ...
            <Modal show={show2} onHide={handleClose2} backdrop="static" keyboard={false} >
                ...
                <Modal.Footer className="modalFooter">
                    ...
                    <Button variant="primary" className="modalButtonPrimary" onClick={() => {approveRentcarPartner(id.original._id)}}>ยืนยัน</Button>
                </Modal.Footer>
            </Modal>
        </>
  </td> 
